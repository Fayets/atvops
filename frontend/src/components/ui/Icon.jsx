...
const PATHS = {
  ...
  // Megáfono: plata en ads
  ads: 'M3.5 8.2v3.6h2.3L10.5 15V5L5.8 8.2H3.5Zm9.2.5a2.4 2.4 0 0 1 0 2.6M14.2 6.4a4.4 4.4 0 0 1 0 7.2',
  // Pantalla + play: webinar en vivo
  webinars: 'M3 5h14v9H3V5Zm5 2.8 4.2 2.2L8 12.2V7.8ZM7 16.5h6M10 14v2.5',
  ...
  // Enchufe: integraciones / conectores externos
  integraciones: 'M8 2.5v4.5M12 2.5v4.5M6.5 7h7v2a3.5 3.5 0 0 1-2.5 3.35V17.5h-2v-5.15A3.5 3.5 0 0 1 6.5 9V7Z',
  // Documento: docs
  docs: 'M6 3.5h5.5L15 7v9.5a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1v-12a1 1 0 0 1 1-1Zm5 0V7h3.5M7.5 10.5h5M7.5 13h5',
  clipboard: 'M7.5 3.5h5v2h-5v-2Zm-1.5 1H4.5A1.5 1.5 0 0 0 3 6v10.5A1.5 1.5 0 0 0 4.5 18h11a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H14',
};
